...
Create a virtual environment then install necessary packages.

### Libraries Needed
- numpy
- joblib
- scikit-learn (if using the examples given in the repository)

## Structure
- NN.py is a framework for classification Neural Networks
- NNreg.py is a framework for regression Neural Networks
